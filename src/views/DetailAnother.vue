<template>
<div>
{{detailAnother}}, ini detail

<div class="container">
       <div class="row mt-3">
        <div class="col-md-6">
          <img :src="detailAnother.imgUrl" class="img-fluid shadow" />
        </div>
        <div class="col-md-6">
          <h2>
...
export default {
    name: "AnotherDetail",
    methods: {
        ...mapActions(useRecipeStores, ["getDetailAnother"]),
          backToHome() {
          this.$router.push({ name: "home" });
      }
    },
    computed: {
        ...mapState(useRecipeStores, ["detailAnother"])
    },
    created() {
        this.getDetailAnother(this.$route.params.id)
    }
}
</script>
