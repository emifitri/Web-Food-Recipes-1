...
<div class="container">
	<div class="screen">
      ...
      <div class="text-center fs-6">
            <h5><strong>Not a member? </strong><router-link to="/register"> Register </router-link></h5>
      </div><br>
      <div class="text-center fs-6">
           <p><strong>Or</strong></p>
      </div><br>
      <div class="text-center fs-6">
           <p><strong> With </strong> <a href="" @click.prevent="handleClickSignIn">Google login</a></p>
      </div><br>
			</form>
